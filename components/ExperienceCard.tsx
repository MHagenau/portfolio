...
function ExperienceCard({ imageURL, featureTitle, featureSubTitle, featureDescription, avatars }: Props) {
  return (
    <article className='flex flex-col rounded-lg items-center space-y-5 flex-shrink-0 w-[350px] h-[400px] md:w-[400px] md:h-[550px]
        ...
        <div className='px-0 md:px-10'>
            ...
            <h4 className='text:lg md:text-xl xl:text-3xl font-light text-[#FFE787]'>{featureSubTitle}</h4>
            <div className='flex space-x-2 my-2'>

                {avatars.map((avatar, i) => (
                    <img key={i} className='mt-2 h-6 w-6 md:w-10 md:h-10 xl:h-15 xl:w-15 object-scale-down object-bottom' 
                    src={avatar} alt=""/>
                ))}
